              ...
              <div className="flex items-center justify-between p-6 border-b border-slate-50 dark:border-slate-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative">
                      ...
                      >
                        <option value="pending" className="bg-white dark:bg-slate-900">待处理</option>
                        <option value="interviewing" className="bg-white dark:bg-slate-900">面试中</option>
                        <option value="passed" className="bg-white dark:bg-slate-900">已通过</option>
                        <option value="rejected" className="bg-white dark:bg-slate-900">已淘汰</option>
                      </select>
